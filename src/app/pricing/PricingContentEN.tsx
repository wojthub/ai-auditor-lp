  ...
  return (
    <section style={{ background: '#ffffff', padding: '44px 0 96px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', paddingLeft: 24, paddingRight: 24, position: 'relative' }}>
        ...
        {/* Order value bonus - tiers mirror CREDIT_BONUS_TIERS in the app (value of 100/200/300 cr = €200/400/600 at €2.00 per credit) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <h2 style={{
            ...
            The bigger the order, the more free credits
          </h2>
          <p style={{ fontSize: 14.5, color: '#36394a', lineHeight: 1.65, margin: '0 0 20px', textAlign: 'center' }}>
            Free credits are added automatically after payment. The tier is based on the amount after discount. 1 credit = 1 audit.
          </p>
            ...
            {[
              ...
              >
                {/* Uklad „placisz → dostajesz": kwota progu i procent bonusu jako glowna liczba — ten
                    sam jezyk co pigulki w koszyku aplikacji („100 cr / +10%"). Rozbicie „100 + 10 = 110
                    credits" pod spodem pokazuje, ile to realnie wchodzi na saldo. */}
                <div style={{ fontSize: 12.5, color: '#818898' }}>You pay from</div>
                ...
                <div style={{ fontSize: 12.5, color: '#818898' }}>You get</div>
                ...
                <div style={{ fontSize: 13, color: '#36394a', marginTop: 2 }}>
                  {tier.credits} + {tier.bonus} = {tier.total} credits
                </div>
                <div style={{ fontSize: 12.5, color: '#36394a', marginTop: 8 }}>
                  {tier.effective} / audit
                </div>
              </div>
            ))}
          </div>
