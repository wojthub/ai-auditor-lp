...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'See the CitationOne scoring standard - 10 AI Search citability dimensions + E-E-A-T that translate LLM algorithms into simple editorial guidelines.',
  },
