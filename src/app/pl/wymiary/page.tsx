...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Poznaj standard oceny CitationOne - 10 wymiarów cytowalności w odpowiedziach AI + E-E-A-T przekładające algorytmy LLM na proste wytyczne redakcyjne.',
  },
