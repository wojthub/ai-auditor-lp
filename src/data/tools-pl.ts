...
export const TOOLS_PL: Record<string, ToolData> = {
  klasteryzacja: {
    ...
    whyHeading: 'Dlaczego warto klasteryzować frazy?',
    why: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Trafiają do osobnej grupy „Bez klastra” i zostają w wyniku. Rozróżniamy trzy sytuacje: fraza miała wyniki, ale nie połączyła się z innymi; fraza nie ma wyników w ogóle; pobranie wyników się nie powiodło i warto je ponowić.',
      },
    ],
    related: [
  ...
  'linki-wewnetrzne': {
    ...
    configTable: {
      ...
      rows: [
        ...
        ['Długość anchora', 'minimalna 1–10 słów (domyślnie 2), maksymalna 1–15 słów (domyślnie 6)'],
    ...
    output: [
      ...
      'Statystyki serwisu: strony zbierające najwięcej odnośników przychodzących oraz strony osierocone, czyli takie, do których nie prowadzi ani jeden link z wnętrza serwisu.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Nie. Przed dopasowaniem wyciągamy istniejące linki wewnętrzne z treści i odrzucamy zarówno podlinkowane już adresy, jak i frazy, które na danej stronie już są odnośnikiem.',
      },
      {
