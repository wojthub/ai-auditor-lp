...
export const DIMENSIONS_PL: Record<string, DimensionData> = {
  ...
  'graf-wiedzy': {
    ...
    report: [
      'Dostajesz matrycę faktów: każdy atrybut z Twoją wartością obok informacji, ilu konkurentów z Top 10 go opisuje. Luki są oznaczone i uszeregowane według tego, jak powszechne są u innych, a Twoje wyróżniki oznaczone osobno.',
