...
export const STRINGS_EN: DimensionStrings = {
  ...
  toc: [
    { id: 'dlaczego', label: 'Why it matters' },
    { id: 'jak-liczymy', label: 'How we measure it' },
    { id: 'czynniki', label: 'What helps and hurts' },
    { id: 'raport', label: 'In the report' },
    { id: 'faq', label: 'FAQ' },
  ],
  ...
  reportHeading: 'What you get in the report',
