        ...
        >
          ...
          <div className="author-body" style={{ flex: 1, padding: '40px 44px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 600, color: '#818898', textTransform: 'uppercase', letterSpacing: '0.08em' }}>O autorze</span>
            </div>
            ...
            <p style={{ fontSize: 15.5, color: '#36394a', lineHeight: 1.68, margin: '0 0 24px' }}>
              Ekspert SEO z ponad 15-letnim doświadczeniem, specjalizujący się we wzroście organicznym w branży finansowej. Obecnie odpowiada za strategię SEO i konwersję w Lendi, z udokumentowanymi sukcesami w skalowaniu marek w najbardziej konkurencyjnej niszy YMYL.
            </p>
