  ...
  return (
    <section className="relative overflow-hidden" style={{ background: '#ffffff' }}>
        ...
        <div className="hero-grid">
          ...
          >
            ...
            <p style={{ fontSize: 17, color: '#36394a', fontWeight: 400, lineHeight: 1.6, margin: '0 0 36px' }}>
              Check if your content is citable by ChatGPT, Perplexity and Google AI Overview.
            </p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 2 }}>
                <div className="score-box" style={{ background: 'rgba(202,138,4,0.06)', borderLeft: '3px solid #CA8A04', borderRadius: 8, padding: '12px 14px', position: 'relative', cursor: 'default' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <span style={{ fontSize: 9, fontWeight: 700, color: '#CA8A04', background: 'rgba(202,138,4,0.12)', border: '1px solid rgba(202,138,4,0.25)', borderRadius: 4, padding: '2px 7px', letterSpacing: '0.06em' }}>WARNING</span>
                  </div>
                  ...
                  <div className="score-tooltip">
                    <strong>Content Quality Score</strong> - aggregated content quality rating (0-100) calculated from 10 AI Search dimensions. The higher the score, the more likely AI models will cite your content.
                  </div>
                </div>
                <div className="score-box" style={{ background: 'rgba(220,38,38,0.06)', borderLeft: '3px solid #DC2626', borderRadius: 8, padding: '12px 14px', position: 'relative', cursor: 'default' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <span style={{ fontSize: 9, fontWeight: 700, color: '#DC2626', background: 'rgba(220,38,38,0.12)', border: '1px solid rgba(220,38,38,0.25)', borderRadius: 4, padding: '2px 7px', letterSpacing: '0.06em' }}>CRITICAL</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
                  ...
                  <div className="score-tooltip">
                    <strong>AI Citability Score</strong> - the probability that ChatGPT, Perplexity or Google AI Overview will cite your content (0-10). Takes into account BLUF structure, information density and sub-query coverage.
                  </div>
                </div>
              </div>
      ...
      <style>{`
        ...
        .score-tooltip { display: none; position: absolute; left: 0; right: 0; top: 100%; margin-top: 6px; background: #0d0d12; color: #e5e7eb; font-size: 12px; line-height: 1.55; padding: 10px 12px; border-radius: 6px; z-index: 10; pointer-events: none; box-shadow: 0 4px 16px rgba(0,0,0,0.18); }
