    ...
    <section style={{ background: '#ffffff', padding: '98px 0' }}>
      <div style={{ maxWidth: 1024, margin: '0 auto', paddingLeft: 24, paddingRight: 24 }}>
        ...
        >
          ...
          <h2 style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.2rem)', fontWeight: 600, color: '#0d0d12', letterSpacing: '-0.025em', lineHeight: 1.25, marginBottom: 20 }}>
            The tool that measures{' '}
            <span style={{ color: ACCENT }}>what AI actually evaluates</span>
          </h2>
          ...
          <motion.a
            ...
            style={{
              ...
              padding: '14px 28px', borderRadius: 8, background: ACCENT,
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 2 }}>
              <div className="sol-score-box" style={{ background: 'rgba(202,138,4,0.06)', borderLeft: '3px solid #CA8A04', borderRadius: 8, padding: '12px 14px', position: 'relative', cursor: 'default', overflow: 'hidden' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                  ...
                  <span className="sol-score-badge" style={{ fontSize: 9, fontWeight: 700, color: '#CA8A04', background: 'rgba(202,138,4,0.12)', border: '1px solid rgba(202,138,4,0.25)', borderRadius: 4, padding: '2px 7px', letterSpacing: '0.06em', whiteSpace: 'nowrap' }}>WARNING</span>
                </div>
      ...
      <style>{`
        ...
        .sol-card { background: #ffffff; border: 1px solid #dfe1e7; border-radius: 12px; padding: 28px 28px 24px; box-shadow: 0 4px 24px rgba(0,0,0,0.06); overflow: hidden; }
