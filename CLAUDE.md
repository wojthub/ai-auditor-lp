...
- **Nad urządzeniem stoi adnotacja** - kropka + nazwa widocznej zakładki (crossfade przez `AnimatePresence`) + trzy kreski pozycji + licznik `1/3`. Jest **nieklikalna** (`span`, nie `button`), bo klikalne mają być tylko strzałki; jej pudełko ma stałą wysokość, inaczej crossfade podskakuje.
